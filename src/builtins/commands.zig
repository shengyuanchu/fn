...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        ...
        .options = &.{
            ...
            .{ .flag = "--yolo", .description = "Disable fn permission checks" },
    ...
    .{
        ...
        .details = &.{
            ...
            "  yolo   Disable fn permission checks",
            "",
    ...
    .{
        ...
        .summary = "Choose the model provider used by fn",
    },
    .{
        .kind = .doctor,
        .token = "doctor",
    ...
    .{
        ...
        .summary = "Show local fn token usage and spend",
        .options = &.{
            .{ .flag = "--period <24h|7d|30d>", .description = "Select a rolling window (default: 30d)" },
            json_option,
        },
        .details = &.{
            "Reports only usage recorded by fn on this machine.",
...
pub const top_level_examples = [_]TopLevelExample{
    ...
    .{ .command = "fn session resume last", .description = "Continue the latest session for this workspace" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .usage, .command = "/usage", .aliases = &.{"/cost"}, .help_entry = "/usage (/cost)", .completion_description = "show local fn tokens, models, and spend", .presentation_category = .account },
    ...
    .{ .kind = .permissions, .command = "/permissions", .help_entry = "/permissions [ask|auto|yolo|reset]", .completion_description = "choose what fn is allowed to do", .presentation_category = .security, .show_in_welcome = true, .has_args = true, .accepts_payload = true },
    ...
    .{ .kind = .feedback, .command = "/feedback", .help_entry = "/feedback", .completion_description = "open the fn issue tracker", .presentation_category = .product, .show_in_welcome = true },
    ...
    .{ .kind = .version, .command = "/version", .help_entry = "/version", .completion_description = "show the fn version", .presentation_category = .general },

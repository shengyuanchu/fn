...
describe("cli: help", () => {
  test(
    ...
    async () => {
      ...
      expect(r.stdout).toContain("https://github.com/shengyuanchu/fn");
      expect(r.stdout).toContain("https://github.com/shengyuanchu/fn/issues");
  ...
  test(
    ...
    async () => {
      ...
      const expected = `fn ask

Run one noninteractive request

Usage:
  fn ask [--auto|--yolo] [--image PATH] [--json] [--quiet] [--prompt-permissions] [--no-save] [--no-color] [--resume <last|id>|--resume-id <id>] [--continue-recovery] [--] <prompt>
...
describe("cli: workspace access", () => {
  test(
    ...
    async () => {
      ...
      expect(help.stdout.startsWith("fn ask\n\n")).toBe(true);
